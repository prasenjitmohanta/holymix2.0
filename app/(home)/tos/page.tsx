  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <p className="mb-4">
        ...
        Holymix, you agree to these Terms of Service and acknowledge that they
        affect your legal rights and obligations.
      </p>
      <p className="mb-4">
        <strong className="font-bold">Content:</strong> Holymix does not host
      ...
      <p className="mb-4">
        ...
        content, such as comments or reviews, responsibly. We reserve the right
        to remove any content that violates our policies or is deemed
        inappropriate.
      </p>
      <p className="mb-4">
        ...
        respective owners. Holymix respects these rights and does not claim
      ...
      <p className="mb-8">
        <strong className="font-bold">Termination:</strong> We may terminate or
        suspend access to our service immediately, without prior notice, for any
